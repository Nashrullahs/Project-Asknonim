...
public class Login2Activity extends AppCompatActivity {
    ...
    private void showRecoverPasswordDialog() {
        ...
        /*sets the min width of a EdiView to fit a text of n 'M' letters regardless of the actual text
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        if(task.isSuccessful()){
                            Toast.makeText(Login2Activity.this, "Email sent", Toast.LENGTH_SHORT).show();
                        }
                        else{
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            startActivity(new Intent(Login2Activity.this, Dashboard2Activity.class));
                            finish();
                        } else {
                            //dismiss progres dialog
                            pd.dismiss();
